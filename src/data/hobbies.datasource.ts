...
export const hobbiesDatasource: HobbyInterface[] = [
  { id: 1, hobby: Hobby.GOLF, icon: markRaw(IconGolf), name: 'Golf', description: `Il y a 2 ans, mon père m'a fait découvrir le golf, et depuis j'y suis accro. J'ai aussi entrainé Olivier LE LAY dans ma chute et j'espère trouver d'autres pratiquants chez Zenika ! 🏌️`, photographs: [ 'golf-1.jpg' ], enabled: false },
  { id: 2, hobby: Hobby.COOKING, icon: markRaw(IconCooking), name: 'Cuisiner', description: `Fan de Top Chef de toujours (ou de toute autre émission/documentaire culinaire), j'adore cuisiner. Et c'est encore mieux si c'est un dessert, pour remplir le bien connu deuxième estomac (celui des desserts pour ceux qui l'auraient pas 😉) 🍰 🎂`, photographs: [ 'cooking-1.jpg', 'cooking-2.jpg' ], enabled: false },
  ...
  { id: 4, hobby: Hobby.READING, icon: markRaw(IconReading), name: 'Lire', description: `Grand adèpte de la lecture fantasy (et pas grand chose d'autre). Mon dernier livre en date, Le Puits des mémoires, pour ceux qui connaissent 📖`, photographs: [ 'reading-1.jpg' ], enabled: false },
  { id: 5, hobby: Hobby.CYCLING, icon: markRaw(IconCycling), name: 'Vélo', description: `Bon, je fais du vélo de temps en temps, et parfois je viens au travail avec 🤷`, photographs: [ 'cycling-1.jpg' ], enabled: false },
  ...
  { id: 9, hobby: Hobby.CLEANING, icon: markRaw(IconCleaning), name: 'Organisé', description: `Certains diront que je suis maniaque, toqué, exigeant, ... Ils auront très sûrement raison, ce qui est sûr c'est que j'organise ma vie au poil de cul. Le dernier outil en date pour mieux tout planifier, et dont je suis maintenant totalement accro: Notion`, photographs: [ 'cleaning-1.jpg' ], enabled: false },
